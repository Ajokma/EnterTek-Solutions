...
function AboutUs() {
    return (
        <section id="about-us">
            <div className="about-us-container flex justify-content-evenly ">
                <h1 className="title-section color-oscuro poppins-font">About us</h1>
                <p className="about-us-paragraph poppins-font">Our story began in 2004 after being founded by Luis A. Vazquez in South Florida.<br/>
